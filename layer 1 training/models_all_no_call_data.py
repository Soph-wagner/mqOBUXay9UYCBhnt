...
Date: 8/5/2024
Description: Creating and comparing 3 different model architectures for the no call features term deposit dataset
             models used: Bagging Classifier, Decision Tree Classifier, Gradient Boosting Classifier
...
models = []
models.append(('Bagging Classifier', bag_clf))
